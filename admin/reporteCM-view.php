<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
	...
	?>
                                        ...
                                        <td class="text-center" data-label="Opciones:">
                                            ...
                                            <a href="admin.php?view=ticketeditCM&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning red-tooltip" data-toggle="tooltip" data-placement="right" id="tooltipex" title="Editar Ticket"><i class="fa fa-eye" aria-hidden="true"></i></a>
