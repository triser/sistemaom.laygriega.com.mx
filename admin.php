...
<html>
    ...
    <body>   
        ...
        <?php
            $WhiteList=["ticketadmin","ticketedit","ticketeditAE","ticketeditHS","ticketeditCS","users","admin","config","reporteAE","reporteHS","reporteCS","admindetalleticket","descripcion-actividad","menu-admin","menu-departamento-actividades"];
